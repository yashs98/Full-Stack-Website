...
<head>
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif, Comfortaa; background-color:aquamarine">
        ...
        <q>A journey of a thousand miles begins with a single step</q> - Lao Tzu
		...
		<section>
			<h2> Contact me </h2>
			<div id="H1">
				If you have questions about myself, contact me using the email <a href="mailto:yash-sinha@outlook.com"> yash-sinha@outlook.com</a>
			</div> 
		</section>
